...
<html lang="en">
  ...
  <link href='https://fonts.googleapis.com/css?family=Lato:400,700' rel='stylesheet' type='text/css'>
	...
	<body>
		...
		<h3 class="header-topic">Remote Sensing and Automation</h3>
		<div  id="form-main">
...
if (($_SERVER["REQUEST_METHOD"] == "POST") && isset($_POST['submit'])) {
  ...
  if ($Err === "false"){
    $query = "INSERT INTO remote (name, gender, college, email, contacts) VALUES ('$name','$gender','$college','$email','$mobile')";
